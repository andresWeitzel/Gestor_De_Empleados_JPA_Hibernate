...
public class JFrameVerEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxBusquedaEmpleados.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECCIONAR", "ID", "NOMBRE", "APELLIDO", "EDAD", "GÉNERO", "TIPO DE DOCUMENTO", "NÚMERO DE DOCUMENTO", "CORREO ELECTRÓNICO", "NÚMERO DE TELÉFONO", "CANTIDAD DE HS SEMANALES", "SUELDO" }));
    ...
    private void jTextFieldBusquedaEmpleadosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBusquedaEmpleadosKeyReleased
        ...
        /*Usando Hibernate el registro fecha lo autoformatea como tipo DATE y NO como STRING, entonces no incluyo la busqueda de fecha */
        if (jComboBoxBusquedaEmpleados.getSelectedItem().equals("ID")) {

            new Table().cargar(jTableListaEmpleados, (List) empleadoRepository.getById(Integer.valueOf(jTextFieldBusquedaEmpleados.getText())));
            ...
            new Table().cargar(jTableListaEmpleados, empleadoRepository.getByEdad(Integer.valueOf(jTextFieldBusquedaEmpleados.getText())));
            ...
            new Table().cargar(jTableListaEmpleados, empleadoRepository.getByCantidadHsSemanales(Integer.valueOf(jTextFieldBusquedaEmpleados.getText())));

        } else if (jComboBoxBusquedaEmpleados.getSelectedItem().equals("SUELDO")) {

            new Table().cargar(jTableListaEmpleados, empleadoRepository.getBySueldo(Integer.valueOf(jTextFieldBusquedaEmpleados.getText())));
